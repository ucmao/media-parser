...
* 📚 **[平台逆向指南索引](docs/index.md)**：包含抖音、快手、小红书、B站等全部 45 个平台的技术文档。
...
### 1. 真实样本交互式验证
样例测试库见 [`tests/live_parser_samples.json`](tests/live_parser_samples.json)，用于实时验证 45 个平台的解析有效性与多形态覆盖：
